<?php
// Script untuk men-generate Test Case Blackbox Excel (.xls) Lengkap dengan Kolom BUKTI IMAGE
$filename = "C:\\Users\\AThariz\\.gemini\\antigravity-ide\\brain\\5fd1bcfd-077a-4e03-bb50-7a8890669438\\Test_Case_Blackbox_Rsix_Dengan_Bukti.xls";

$columns = ["ID TC", "Role / Aktor", "Skenario Uji (CRUD)", "Precondition", "Langkah Pengujian", "Data Uji", "Hasil Diharapkan", "Status", "Bukti (Screenshot)"];
...
foreach ($features as $featureName => $rows) {
    ...
    $xml .= "    <Cell ss:MergeAcross=\"8\" ss:StyleID=\"sTitle\"><Data ss:Type=\"String\">" . htmlspecialchars($featureName, ENT_XML1, "UTF-8") . "</Data></Cell>\n";
    $xml .= "   </Row>\n";
    ...
    // Add data rows
    foreach ($rows as $row) {
        // Since we need to insert blank lines representing space for the image
        // Let's make the row height taller for image insertion if we want
...
echo "Berhasil membuat file Excel dengan Kolom Bukti: " . $filename . "\n";
?>
