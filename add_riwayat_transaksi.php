  ...
  <diagram id="riwayat_transaksi" name="20. Riwayat Transaksi Karyawan">
    <mxGraphModel dx="1000" dy="1000" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
      <root>
        ...
        <mxCell id="rt_n3" value="Pilih Data &amp; Klik Detail" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;" vertex="1" parent="lane_u_rt">
          <mxGeometry x="80" y="360" width="140" height="60" as="geometry" />
        </mxCell>
        <mxCell id="rt_s2" value="Tampilkan Detail Transaksi (Barang &amp; Struk)" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;" vertex="1" parent="lane_s_rt">
          <mxGeometry x="70" y="460" width="160" height="60" as="geometry" />
        </mxCell>
        <mxCell id="rt_n4" value="" style="ellipse;html=1;shape=endState;fillColor=#000000;strokeColor=#000000;" vertex="1" parent="lane_u_rt">
...
$content = preg_replace('/<diagram id="riwayat_transaksi"[\s\S]*?<\/diagram>/i', '', $content);
$content = preg_replace('/<\/mxfile>\s*$/i', $xml . "\n</mxfile>\n", $content);
file_put_contents('Activity_Diagrams_Rsix_Cell.drawio', $content);
echo "Diagram Riwayat Transaksi ditambahkan.\n";
