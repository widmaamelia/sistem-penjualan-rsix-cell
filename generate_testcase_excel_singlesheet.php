<?php
// Script untuk men-generate Test Case Blackbox (Pisah Tabel tapi 1 Sheet)

$filename = "C:\\Users\\AThariz\\.gemini\\antigravity-ide\\brain\\5fd1bcfd-077a-4e03-bb50-7a8890669438\\Test_Case_Blackbox_Rsix_SatuSheet_BanyakTabel.xls";
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Styles>
  ...
  <Style ss:ID="sTitle">
   ...
   <Font ss:FontName="Calibri" x:Family="Swiss" ss:Size="14" ss:Color="#1F497D" ss:Bold="1"/>
...
foreach ($features as $featureName => $rows) {
    // Escape feature name
    $featureNameEsc = htmlspecialchars("Pengujian Fitur: " . $featureName, ENT_XML1, "UTF-8");
    
    // Add title row for this feature
    $xml .= "   <Row ss:Height=\"20\">\n";
    $xml .= "    <Cell ss:MergeAcross=\"5\" ss:StyleID=\"sTitle\"><Data ss:Type=\"String\">{$featureNameEsc}</Data></Cell>\n";
    $xml .= "   </Row>\n";
...
echo "Berhasil membuat file Excel: " . $filename . "\n";
?>
