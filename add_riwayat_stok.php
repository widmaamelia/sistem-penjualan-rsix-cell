  ...
  <diagram id="riwayat_stok" name="19. Riwayat Stok">
    <mxGraphModel dx="1000" dy="1000" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
      <root>
        ...
        <mxCell id="rs_n2" value="Akses Menu Riwayat Stok" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;" vertex="1" parent="lane_u_rs">
          <mxGeometry x="80" y="160" width="140" height="60" as="geometry" />
        </mxCell>
        <mxCell id="rs_s1" value="Tampilkan Daftar Riwayat Stok" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;" vertex="1" parent="lane_s_rs">
          <mxGeometry x="80" y="260" width="140" height="60" as="geometry" />
        </mxCell>
        <mxCell id="rs_n3" value="Filter Waktu / Cari Produk" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;" vertex="1" parent="lane_u_rs">
          <mxGeometry x="80" y="360" width="140" height="60" as="geometry" />
        </mxCell>
        <mxCell id="rs_s2" value="Update Tampilan Riwayat Stok" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;" vertex="1" parent="lane_s_rs">
...
// Jika diagram Riwayat Stok sudah ada, kita hapus dulu
$content = preg_replace('/<diagram id="riwayat_stok"[\s\S]*?<\/diagram>/i', '', $content);
$content = preg_replace('/<\/mxfile>\s*$/i', $xml . "\n</mxfile>\n", $content);
file_put_contents('Activity_Diagrams_Rsix_Cell.drawio', $content);
echo "Diagram Riwayat Stok ditambahkan.\n";
