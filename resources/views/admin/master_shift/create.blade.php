...
<div class="form-container" style="background: white; border-radius: 12px; border: 1px solid #e5e7eb; padding: 30px; margin: 0 auto; max-width: 800px;">
    <h6 class="text-uppercase fw-bold mb-4" style="font-size:12px; color: #1a5ca6; letter-spacing:0.5px;">Tambah Master Shift</h6>
    ...
    <form action="{{ route('master_shift.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_shift" class="form-control" placeholder="Contoh: Shift Pagi" required style="border-radius: 8px; border: 1px solid #d1d5db; padding: 10px 15px; font-size: 14px;">
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6 mb-3">
                ...
                <input type="time" name="jam_mulai" class="form-control" required style="border-radius: 8px; border: 1px solid #d1d5db; padding: 10px 15px; font-size: 14px;">
            </div>
            <div class="col-md-6 mb-3">
                ...
                <input type="time" name="jam_selesai" class="form-control" required style="border-radius: 8px; border: 1px solid #d1d5db; padding: 10px 15px; font-size: 14px;">
            </div>
        </div>
        ...
        <div class="d-flex gap-2 justify-content-end">
            ...
            <button type="submit" class="btn btn-primary" style="background-color: #1a5ca6; border-color: #1a5ca6; border-radius: 6px; font-weight: 500; padding: 6px 16px; font-size: 13.5px;"><i class="fa-solid fa-floppy-disk me-1"></i> Simpan Shift</button>
        </div>
    </form>
</div>
@endsection
