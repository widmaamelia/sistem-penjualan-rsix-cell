  ...
  <diagram id="logout_activity" name="10. Logout">
    <mxGraphModel dx="1000" dy="1000" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
      <root>
        ...
        <mxCell id="lout_nx1" value="Buka Halaman Profil" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;" vertex="1" parent="lane_u_logout">
          <mxGeometry x="80" y="160" width="140" height="60" as="geometry" />
        </mxCell>
        <mxCell id="lout_nx2" value="Tampilkan Halaman Profil" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;" vertex="1" parent="lane_s_logout">
        ...
        <mxCell id="lout_e1" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;" edge="1" parent="1" source="lout_n1" target="lout_nx1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="lout_ex1" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;" edge="1" parent="1" source="lout_nx1" target="lout_nx2">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="lout_ex2" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;" edge="1" parent="1" source="lout_nx2" target="lout_n2">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
...
$content = preg_replace('/<diagram id="logout_activity"[\s\S]*?<\/diagram>/i', $xml, $content);
file_put_contents('Activity_Diagrams_Rsix_Cell.drawio', $content);
echo "Diagram Logout diperbarui.\n";
