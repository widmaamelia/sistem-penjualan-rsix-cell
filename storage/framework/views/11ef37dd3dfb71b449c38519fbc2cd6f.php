<?php $__env->startSection('title', 'Edit Pengguna - ' . $pengguna->name); ?>
...
<!-- Header -->
<div class="mb-4">
    <a href="<?php echo e(route('pengguna.index')); ?>" class="btn btn-light bg-white" style="border-radius: 8px; border: 1px solid #e5e7eb; color: #4b5563; padding: 8px 14px; box-shadow: 0 1px 2px rgba(0,0,0,0.02);" title="Kembali">
...
<div class="form-card p-3 bg-white" style="border-radius: 12px; border: 1px solid #e5e7eb;">
    ...
    <form action="<?php echo e(route('pengguna.update', $pengguna->id_user)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="row mb-2">
            <div class="col-md-6 mb-2">
                ...
                <input type="text" name="name" class="form-control form-control-sm" value="<?php echo e(old('name', $pengguna->name)); ?>" required>
            </div>
            <div class="col-md-6 mb-2">
                <label class="form-label" style="font-size: 11px; margin-bottom: 4px;">Alamat Email <span class="required-star">*</span></label>
                <input type="email" name="email" class="form-control form-control-sm" value="<?php echo e(old('email', $pengguna->email)); ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-1">
            <div class="col-md-3 mb-2">
                ...
                <select name="role" id="roleSelect" class="form-select form-select-sm" required>
                    <option value="super" <?php echo e(old('role', $pengguna->role) == 'super' ? 'selected' : ''); ?>>Super Admin</option>
                    <option value="admin cabang" <?php echo e(old('role', $pengguna->role) == 'admin cabang' ? 'selected' : ''); ?>>Admin Cabang</option>
                    <option value="karyawan" <?php echo e(old('role', $pengguna->role) == 'karyawan' ? 'selected' : ''); ?>>Karyawan (Kasir)</option>
                </select>
            </div>
            <div class="col-md-3 mb-2" id="cabangContainer">
                ...
                <select name="id_cabang" id="cabangSelect" class="form-select form-select-sm">
                    <option value="" disabled <?php echo e(!$pengguna->id_cabang ? 'selected' : ''); ?>>-- Pilih Cabang --</option>
                    <?php $__currentLoopData = $cabangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cabang->id_cabang); ?>" <?php echo e(old('id_cabang', $pengguna->id_cabang) == $cabang->id_cabang ? 'selected' : ''); ?>><?php echo e($cabang->nama_cabang); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-3 mb-2">
                ...
                <select name="status" class="form-select form-select-sm" required>
                    <option value="aktif" <?php echo e(old('status', $pengguna->status) == 'aktif' ? 'selected' : ''); ?>>Aktif (Bisa Login)</option>
                    <option value="nonaktif" <?php echo e(old('status', $pengguna->status) == 'nonaktif' ? 'selected' : ''); ?>>Non-aktif (Diblokir)</option>
                </select>
            </div>
            <div class="col-md-3 mb-2">
        ...
        <div class="d-flex gap-2 justify-content-end">
            <a href="<?php echo e(route('pengguna.index')); ?>" class="btn btn-outline-secondary btn-sm" style="border-radius: 6px; font-weight: 500;">Batal</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester_6\TUGAS AKHIR NGODING\sistem-penjualan-rsix-cell\resources\views/admin/pengguna/edit.blade.php ENDPATH**/ ?>