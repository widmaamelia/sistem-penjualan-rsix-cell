<?php $__env->startSection('title', 'Rekap Laporan Seluruh Cabang'); ?>
        ...
        <div class="card border-0 shadow-sm rounded-3 bg-secondary text-white h-100">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h4 class="m-0 fw-bold"><?php echo e(number_format($globalTransaksi, 0, ',', '.')); ?></h4>
                </div>
        ...
        <div class="card border-0 shadow-sm rounded-3 bg-success text-white h-100">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h4 class="m-0 fw-bold">Rp <?php echo e(number_format($globalUangMasuk, 0, ',', '.')); ?></h4>
                </div>
                <div class="fs-3 text-white-50">
        ...
        <div class="card border-0 shadow-sm rounded-3 bg-danger text-white h-100">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h4 class="m-0 fw-bold">Rp <?php echo e(number_format($globalUangKeluar, 0, ',', '.')); ?></h4>
                </div>
                <div class="fs-3 text-white-50">
        ...
        <div class="card border-0 shadow-sm rounded-3 bg-info text-white h-100">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h4 class="m-0 fw-bold">Rp <?php echo e(number_format($globalLaba, 0, ',', '.')); ?></h4>
                </div>
                <div class="fs-3 text-white-50">
...
<div class="card shadow-sm border-0 rounded-3 mb-4">
    <div class="card-body">
        <form action="<?php echo e(route('laporan.index')); ?>" method="GET" class="row g-3 align-items-end">
            <div class="col-md-10">
                <label class="form-label text-muted" style="font-size: 12px;">Filter Rentang Tanggal</label>
                <input type="text" name="date_range" id="date_range" class="form-control" placeholder="Pilih tanggal mulai s/d tanggal akhir" value="<?php echo e(request('date_range')); ?>">
            </div>
        ...
        <table class="table mb-0 align-middle table-hover text-nowrap">
            ...
            <tbody>
                <?php $__currentLoopData = $cabangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="px-3 py-2">
                            <span class="fw-bold text-primary d-block" style="font-size: 13px;"><?php echo e($cabang->nama_cabang); ?></span>
                            <small class="text-muted" style="font-size: 11px;"><?php echo e(Str::limit($cabang->alamat, 30)); ?></small>
                        </td>
                        <td class="px-3 py-2 text-center fw-bold text-dark" style="font-size: 12px;"><?php echo e($cabang->total_transaksi); ?></td>
                        <td class="px-3 py-2 text-end fw-bold text-success" style="font-size: 12px;">Rp <?php echo e(number_format($cabang->total_uang_masuk, 0, ',', '.')); ?></td>
                        <td class="px-3 py-2 text-end fw-bold text-danger" style="font-size: 12px;">Rp <?php echo e(number_format($cabang->total_uang_keluar, 0, ',', '.')); ?></td>
                        <td class="px-3 py-2 text-end fw-bold text-info" style="font-size: 12px;">Rp <?php echo e(number_format($cabang->total_laba, 0, ',', '.')); ?></td>
                        <td class="px-3 py-2 text-center">
                            <?php
                                $detailParams = request()->all();
                                $detailParams['id_cabang'] = $cabang->id_cabang;
                            ?>
                            <a href="<?php echo e(route('laporan.index', $detailParams)); ?>" class="btn btn-sm btn-outline-primary rounded-pill py-0 px-2" style="font-size: 11px;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester_6\TUGAS AKHIR NGODING\sistem-penjualan-rsix-cell\resources\views/admin/laporan/index_super.blade.php ENDPATH**/ ?>