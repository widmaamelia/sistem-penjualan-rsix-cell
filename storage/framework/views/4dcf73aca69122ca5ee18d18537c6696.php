...
<form action="<?php echo e(route('produk.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="header-action">
        <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-light" style="border-radius: 8px; border: 1px solid #e5e7eb; color: #4b5563; padding: 8px 14px;" title="Kembali">
            <i class="fa-solid fa-arrow-left"></i>
        </a>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-outline-secondary" style="border-radius: 6px; font-weight: 500; padding: 6px 16px; font-size: 13.5px;">Batal</a>
    ...
    <div class="form-card p-3 bg-white" style="border-radius: 12px; border: 1px solid #e5e7eb;">
            ...
            <div class="col-md-10">
                ...
                <div class="row mb-2">
                    <div class="col-md-5 mb-2">
                        ...
                        <input type="text" name="nama_produk" class="form-control form-control-sm" placeholder="Contoh: Samsung Galaxy S24 Ultra" value="<?php echo e(old('nama_produk')); ?>" required>
                    </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-3 mb-2">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="number" name="harga_beli" class="form-control form-control-sm" placeholder="0" value="<?php echo e(old('harga_beli', 0)); ?>" required min="0">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <div class="input-group input-group-sm">
                            <span class="input-group-text">Rp</span>
                            <input type="number" name="harga_jual" class="form-control form-control-sm <?php echo e(auth()->user()->role === 'admin cabang' ? 'bg-light text-muted' : ''); ?>" placeholder="0" value="<?php echo e(old('harga_jual', 0)); ?>" required min="0" <?php echo e(auth()->user()->role === 'admin cabang' ? 'readonly tabindex="-1"' : ''); ?>>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-4 col-6 mb-2">
                <label class="form-label text-muted d-block text-truncate" style="font-size:10px; margin-bottom: 3px;" title="<?php echo e($cabang->nama_cabang); ?>"><?php echo e($cabang->nama_cabang); ?></label>
                <div class="qty-input-group d-flex w-100" style="border: 1px solid #d1d5db; border-radius: 4px; overflow: hidden; height: 28px;">
                    <button type="button" class="qty-btn btn-minus bg-light border-0 px-2" onclick="decreaseQty('stok_<?php echo e($cabang->id_cabang); ?>')"><i class="fa-solid fa-minus" style="font-size: 9px;"></i></button>
                    <input type="number" name="stok_cabang[<?php echo e($cabang->id_cabang); ?>]" id="stok_<?php echo e($cabang->id_cabang); ?>" class="qty-input stok-input border-0 text-center w-100" value="0" min="0" onchange="calculateTotal()" style="outline: none; background: white; font-size: 11px;">
                    <button type="button" class="qty-btn btn-plus bg-light border-0 px-2" onclick="increaseQty('stok_<?php echo e($cabang->id_cabang); ?>')"><i class="fa-solid fa-plus" style="font-size: 9px;"></i></button>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester_6\TUGAS AKHIR NGODING\sistem-penjualan-rsix-cell\resources\views/admin/produk/create.blade.php ENDPATH**/ ?>