    ...
    <form action="<?php echo e(route('pengguna.store')); ?>" method="POST">
        ...
        <div class="row mb-2">
            <div class="col-md-6 mb-2">
                ...
                <input type="text" name="name" class="form-control form-control-sm" placeholder="Contoh: Budi Santoso" value="<?php echo e(old('name')); ?>" required>
            </div>
            <div class="col-md-6 mb-2">
                <label class="form-label" style="font-size: 11px; margin-bottom: 4px;">Alamat Email <span class="required-star">*</span></label>
                <input type="email" name="email" class="form-control form-control-sm" placeholder="Contoh: budi@rsixcell.com" value="<?php echo e(old('email')); ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-1">
            <div class="col-md-4 mb-2">
                ...
                <select name="role" id="roleSelect" class="form-select form-select-sm" required>
                    ...
                    <option value="super" <?php echo e(old('role') == 'super' ? 'selected' : ''); ?>>Super Admin</option>
                    <option value="admin cabang" <?php echo e(old('role') == 'admin cabang' ? 'selected' : ''); ?>>Admin Cabang</option>
                    <option value="karyawan" <?php echo e(old('role') == 'karyawan' ? 'selected' : ''); ?>>Karyawan (Kasir)</option>
                </select>
            </div>
            <div class="col-md-4 mb-2" id="cabangContainer">
                ...
                <select name="id_cabang" id="cabangSelect" class="form-select form-select-sm">
                    ...
                    <?php $__currentLoopData = $cabangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cabang->id_cabang); ?>" <?php echo e(old('id_cabang') == $cabang->id_cabang ? 'selected' : ''); ?>><?php echo e($cabang->nama_cabang); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-4 mb-2">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester_6\TUGAS AKHIR NGODING\sistem-penjualan-rsix-cell\resources\views/admin/pengguna/create.blade.php ENDPATH**/ ?>