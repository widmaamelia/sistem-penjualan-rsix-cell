<?php
// Script untuk men-generate Test Case Blackbox Format Word (.doc) Lengkap dengan Skenario CRUD Penuh
$filename = "C:\\Users\\AThariz\\.gemini\\antigravity-ide\\brain\\5fd1bcfd-077a-4e03-bb50-7a8890669438\\Test_Case_Blackbox_Rsix_Full_CRUD.doc";
...
<style>
    ...
    th { background-color: #0F5A3F; color: white; border: 1px solid black; padding: 5px; text-align: center; font-weight: bold; }
    td { border: 1px solid black; padding: 5px; vertical-align: top; }
    h3 { margin-bottom: 5px; color: #0C4631; font-size: 16px; border-bottom: 2px solid #0C4631; padding-bottom: 3px;}
</style>
</head>
<body>
<h2 style="text-align: center; font-size: 18px;">Skenario Pengujian Blackbox (CRUD Lengkap)</h2>';
...
foreach ($features as $featureName => $rows) {
    ...
    <thead>
        <tr>
            ...
            <th width="15%">Skenario Uji (CRUD)</th>
...
echo "Berhasil membuat file Word Full CRUD: " . $filename . "\n";
?>
